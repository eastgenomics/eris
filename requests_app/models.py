...
class ReferenceGenome(models.Model):
    ...
    refget_md5 = models.CharField(
        verbose_name="Unique checksum ID generated by refget", max_length=255, null=True
    )
    ...
    refget_version = models.CharField(
        verbose_name="refget version used to generate checksum in refget_md5", max_length=255, null=True
    )
