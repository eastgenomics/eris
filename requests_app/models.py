...
class ReferenceGenome(models.Model):
    ...
    refget_md5 = models.CharField(
        verbose_name="Unique checksum ID generated by refget", max_length=255, null=False
    )

    #TODO: should 'length' be detailed in a Chromosome - ReferenceGenome linking table, instead?
    length = models.IntegerField(
        verbose_name="chromosome contig length, in bases", null=False
    )

    ga4gh_id = models.CharField(
        verbose_name="GA4GH ID", max_length=255, null=False
    )

    refget_version = models.CharField(
        verbose_name="refget version used to generate checksum in refget_md5", max_length=255, null=False
    )
