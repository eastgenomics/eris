...
def _prepare_mane_file(
    ...
    filtered_mane = filtered_mane[["Gene", "MANE TYPE", "RefSeq StableID GRCh38 / GRCh37", "HGNC_ID"]]

    return filtered_mane
...
def _transcript_assign_to_source(tx: str, hgnc_id: str, mane_data: pd.DataFrame, markname_hgmd: dict, 
