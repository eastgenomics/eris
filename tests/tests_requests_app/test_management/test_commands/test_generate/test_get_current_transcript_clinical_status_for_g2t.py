...
from requests_app.management.commands.generate import (
    Command
)
...
class TestCurrentTranscript_ManeSelectOnly(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.gene = Gene.objects.create(hgnc_id="HGNC:987",
                                        gene_symbol="YFG1",
                                        alias_symbols=None)
        
        self.transcript = Transcript.objects.create(transcript="NM001",
    ...
    def test_mane_select_is_clinical_other_sources_dont_exist(self):
        ...
        """
        cmd = Command()
        clinical = cmd.get_current_transcript_clinical_status_for_g2t(self.transcript,
